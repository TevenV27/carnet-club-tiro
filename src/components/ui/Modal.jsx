    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
      <div className="w-full max-w-4xl bg-tactical-dark border border-tactical-border shadow-[0_0_35px_rgba(0,0,0,0.6)]">
        <header className="flex items-center justify-between border-b border-tactical-border px-6 py-4">
          <h3 className="text-lg font-tactical text-tactical-gold uppercase tracking-[0.08em]">
            {title}
          </h3>
          <button
            onClick={onClose}
            className="text-tactical-brass/90 hover:text-tactical-gold transition-colors duration-150 font-tactical text-sm uppercase tracking-[0.05em]"
          >
            Cerrar
          </button>
        </header>
